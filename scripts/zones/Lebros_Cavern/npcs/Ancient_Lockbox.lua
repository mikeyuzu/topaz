        ...
        },
        {
            {itemid = 2277, droprate =  500,    -- ???_earring ？？？イヤリング
                Appraise = {
                    ...
                    -- only
                    {itemid = 15968, appraiserate = 10},   -- storm_loop ストームピアス
                }
            },
        ...
        },
        {
            {itemid = 2279, droprate =  500,    -- ???_cape ？？？ケープ
                Appraise = {
                    ...
                    -- only
                    {itemid =  15489, appraiserate = 10},   -- storm_cape ストームケープ
                }
            },
            {itemid = 2286, droprate =  500,    -- ???_box ？？？ボックス
                Appraise = {
                    ...
                    {itemid =  5318, appraiserate = 10},   -- toolbag_(kodoku) 忍だすき【蠱毒】
                    -- only
                    {itemid =  1270, appraiserate = 10},   -- arachne_web アラクネの網
                }
            }
        }
    },
        ...
        },
        {
            {itemid = 2276, droprate =  500,    -- ???_headpiece ？？？ヘッドウェア
                Appraise = {
                    ...
                    -- only
                    {itemid = 16066, appraiserate = 10},   -- storm_turban ストームターバン
                }
            },
            {itemid = 2193, droprate =  500,    -- ???_axe ？？？アクス
                Appraise = {
                    ...
                    -- only
                    {itemid = 18484, appraiserate = 10},   -- wamoura_axe ワモーラアクス
                }
            },
            {itemid = 2286, droprate =  500,    -- ???_box ？？？ボックス
                Appraise = {
        ...
        },
        {
            {itemid = 2191, droprate =  500,    -- ???_dagger ？？？ダガー
                Appraise = {
                    ...
                    -- only
                    {itemid = 18416, appraiserate = 10},   -- karasuageha 鴉揚羽
                }
            },
            {itemid = 2286, droprate =  500,    -- ???_box ？？？ボックス
                Appraise = {
                    ...
                    {itemid =  5318, appraiserate = 10},   -- toolbag_(kodoku) 忍だすき【蠱毒】
                    -- only
                    {itemid =  5341, appraiserate = 10},   -- spartan_bullet_pouch 胴乱【スパルタン】
                }
            }
        }
    },
        ...
        },
        {
            {itemid = 2192, droprate =  500,    -- ???_polearm ？？？ポールアーム
                Appraise = {
                    ...
                    -- only
                    {itemid = 18407, appraiserate = 10},   -- imperial_wand インペリアルワンド
                }
            },
            {itemid = 2286, droprate =  500,    -- ???_box ？？？ボックス
                Appraise = {
        ...
        },
        {
            {itemid = 2280, droprate =  500,    -- ???_sash ？？？サッシュ
                Appraise = {
                    ...
                    -- only
                    {itemid = 15293, appraiserate = 10},   -- gleemans_belt グリーマンベルト
                }
            },
            {itemid = 2277, droprate =  500,    -- ???_earring ？？？イヤリング
                Appraise = {
                    ...
                    {itemid = 14761, appraiserate = 10},   -- elusive_earring エルシヴイヤリング
                    -- only
                    {itemid = 15980, appraiserate = 10},   -- magnifying_earring マグニファイピアス
                }
            },
            {itemid = 2286, droprate =  500,    -- ???_box ？？？ボックス
                Appraise = {
        ...
        },
        {
            {itemid = 2192, droprate =  500,    -- ???_polearm ？？？ポールアーム
                Appraise = {
                    ...
                    {itemid =  1020, appraiserate = 10},   -- sickle 草刈鎌
                    -- only
                    {itemid = 18843, appraiserate = 10},   -- flan_smasher フランスマッシャー
                }
            },
            {itemid = 2190, droprate =  500,    -- ???_sword ？？？ソード
                Appraise = {
                    ...
                    -- only
                    {itemid = 18438, appraiserate = 10},   -- kumokirimaru 蜘蛛切丸
                }
            },
            {itemid = 2193, droprate =  500,    -- ???_axe ？？？アクス
                Appraise = {
                    ...
                    {itemid =  1021, appraiserate = 10},   -- hatchet まさかり
                    -- only
                    {itemid = 18487, appraiserate = 10},   -- eriks_axe エイリークアクス
                }
            },
            {itemid = 2286, droprate =  500,    -- ???_box ？？？ボックス
                Appraise = {
        ...
        },
        {
            {itemid = 2282, droprate =  500,    -- ???_necklace ？？？ネックレス
                Appraise = {
                    ...
                    -- only
                    {itemid =  15536, appraiserate = 10},   -- rho_necklace ローネックレス
                },
            },
            {itemid = 2278, droprate =  500,    -- ???_ring ？？？リング
                Appraise = {
                    ...
                    -- only
                    {itemid = 15796, appraiserate = 10},   -- psi_ring プサイリング
                }
            },
            {itemid = 2286, droprate =  500,    -- ???_box ？？？ボックス
                Appraise = {
        ...
        },
        {
            {itemid = 2277, droprate =  500,    -- ???_earring ？？？イヤリング
                Appraise = {
                    ...
                    {itemid = 14761, appraiserate = 10},   -- elusive_earring エルシヴイヤリング
                    -- only
                    {itemid = 15987, appraiserate = 10},   -- epsilon_earring イプシロンピアス
                }
            },
            {itemid = 2280, droprate =  500,    -- ???_sash ？？？サッシュ
                Appraise = {
                    ...
                    {itemid = 15870, appraiserate = 10},   -- maharajas_belt マハラジャベルト
                    -- only
                    {itemid = 15902, appraiserate = 10},   -- lambda_sash ラムダサッシュ
                }
            },
            {itemid = 2286, droprate =  500,    -- ???_box ？？？ボックス
                Appraise = {
        ...
        },
        {
            {itemid = 2281, droprate =  500,    -- ???_shield ？？？シールド
                Appraise = {
                    ...
                    -- only
                    {itemid = 16169, appraiserate = 10},   -- caballero_shield カバレーロシールド
                }
            },
            {itemid = 2276, droprate =  500,    -- ???_headpiece ？？？ヘッドウェア
                Appraise = {
                    ...
                    {itemid = 12465, appraiserate = 10},   -- cotton_headgear コットンヘッドギア
                    -- only
                    {itemid = 16125, appraiserate = 10},   -- breeder_mask ブリーダーマスク
                }
            },
            {itemid = 2286, droprate =  500,    -- ???_box ？？？ボックス
                Appraise = {
