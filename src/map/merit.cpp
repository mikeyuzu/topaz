...
static uint8 upgrade[10][46] = {
    ...
    {  1,  3,  5,  7,  9, 12, 15, 18, 21, 24, 27, 30, 33, 36, 39,
      42, 45, 45, 45, 45, 45, 45, 45, 45, 45, 45, 48, 48, 48, 48,
      48, 48, 48, 48, 48, 48, 51, 51, 51, 51, 51, 51, 51, 51, 51 } // Max merits
};
...
static uint8 cap[100] = {
    ...
    8,  8,  8,  8,  8,                      // 65-69 8
    9,  9,  9,  9,  9,                      // 70-74 9
    45, 45, 45, 45, 45,                     // 75-79 45
    45, 45, 45, 45, 45, 45, 45, 45, 45, 45, // 80-89 45
    45, 45, 45, 45, 45, 45, 45, 45, 45, 45, // 90-99 45
};
